...
# Read data
try:
    disney_df = pd.read_csv('../../data/raw data/DisneylandReviews.csv', encoding='utf-8', encoding_errors='replace')
...
try:
    uss_df = pd.read_csv('../../data/raw data/universal_studio_branches.csv',
                         encoding='utf-8',
